<script lang="ts">
	...
	import type { Battlefy } from './types';
	import { getStores, navigating, page, updated } from '$app/stores';

	let post: any;
	onMount(async () => {
		post = await fetch('https://api.battlefy.com/stages/64f11a6c105f1e212e8af978/matches', {
			method: 'GET',
			headers: {
	...
	let bracketName = $page.url.searchParams.get('bracket');
	$: if (post)
